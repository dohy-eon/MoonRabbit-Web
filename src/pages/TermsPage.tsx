          ...
          <div className="space-y-8 text-darkWalnut font-gothicFont">
            <section>
              ...
              <p className="leading-relaxed">
                본 약관은 달토끼(이하 "회사")가 제공하는 서비스(이하 "서비스")의
            ...
            <section>
              ...
              <div className="space-y-2">
                ...
                <p>
                  2. "이용자"라 함은 서비스에 접속하여 본 약관에 따라 서비스를
                  이용하는 회원 및 비회원을 의미합니다.
                </p>
                <p>
                  3. "회원"이라 함은 서비스에 개인정보를 제공하여 회원등록을 한
            ...
            <section>
              ...
              <div className="space-y-2">
                ...
                <p>
                  2. 회사는 합리적인 사유가 발생할 경우에는 본 약관을 변경할 수
                  있으며, 약관을 변경할 경우에는 적용일자 및 변경사유를 명시하여
                  현행약관과 함께 서비스의 초기화면에 그 적용일자 7일 이전부터
                  공지합니다.
                </p>
                <p>
                  3. 회원이 변경된 약관에 동의하지 않는 경우, 회원은 본인의
            ...
            <section>
              ...
              <div className="space-y-2">
                ...
                <p>
                  2. 회사는 서비스의 기술적 사양의 변경 등의 경우에는 장차
                  체결되는 계약에 의해 제공할 서비스의 내용을 변경할 수
                  있습니다.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                회사는 관련법령이 정하는 바에 따라서 이용자 등록정보를 포함한
                이용자의 개인정보를 보호하기 위하여 노력합니다. 이용자의
                개인정보보호에 관해서는 관련법령 및 회사가 정하는
                개인정보처리방침에 정한 바에 의합니다.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="space-y-2">
                <p>
                  1. 회원은 자신의 ID 및 비밀번호에 대한 관리책임이 있습니다.
                </p>
                <p>
